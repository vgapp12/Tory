...
(ide.base::restore-configuration
    ...
    :find-in-files-search-subprojects-later t
    ...
    :patch-reminder-previous-time 3706968614
    ...
    :query-os-exit nil
    :recent
       (list (list :open-project) (list :load-project) (list :open-file) (list :load-file) (list :edit-definition))
    :recent-limit 18
    ...
    :show-quick-symbol-info-on-space t
